...
const Dashboard = () => {
  ...
  useEffect(() => {
    const playWelcomeMessage = () => {
      ...
      const welcomeText = `Hi ${userData.fullName}, welcome to bluepay to the latest version of bluepay 2026, where you can make 200,000 naira daily just by purchasing your BPC code for the sum of 6,500 naira, kindly click on the BPC button to purchase your code directly from the application, have a nice day.`;
